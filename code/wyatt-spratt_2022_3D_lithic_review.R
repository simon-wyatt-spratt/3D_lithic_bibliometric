...
### established and increasingly common analytical tool for stone artefact analysis. 3D modelling methods now include
### laser scanning, photogrammetry, and CT scanning. These have been combined with a variety of different analytical 
### approaches - from geometric morphometrics to custom reduction indices to digital elevation maps. 3D lithic 
### analyses are increasingly global in scope and studies aim to address an ever-broadening breadth of research topics
### ranging from the functional efficiency of tools to the spread of hominid populations. While the impact of the 
### computational revolution on lithic analysis has been reviewed, the application of 3D modelling to lithic analysis 
### has yet to be comprehensively assessed. This paper presents a review of how 3D modelling in particular has 
### impacted the field of lithic analysis. It combines a quantitative bibliometric analysis with a qualitative review 
### to assess just how “revolutionary” 3D modelling has been for lithic analysis. It explores  trends in the use of 
### 3D modelling in stone artefact analysis, its impact  on the wider lithic analysis field, and methodological, 
### regional and theoretical gaps which future research projects could explore.
...
options(width=100)
summary(object = biblio.com, k = 10, pause = FALSE)  # bibliometric summary of the full dataset
summary(object = biblio.ill, k = 10, pause = FALSE)  # bibliometric summary of the illustrative dataset
...
kw.ca3 <- summary(object = biblio.ca3, k = 100, pause = FALSE) # Data for Table 1. was extracted from this summary data. 
...
# different countries. Figure produced from the analytical dataset used.
...
sites.table3        <- filter(sites.table2, sitrs.vector.clean2 != "N/A")
